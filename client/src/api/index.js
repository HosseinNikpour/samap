...
export const getItems = (storeIndex,params) => {
...
export const insertItem = (data, storeIndex, ct) => {
    if (ct) {
...
export const deleteItem = (id, storeIndex) => axios.delete(
    URL + "api/" + storeIndex + "/" + id,
    config
)
