...
const InvoicePayment = (props) => {
    ...
    const getData = () => {
        ...
        getItems("invoice/vw", { tbName: 'invoice_vw1', where: '  WHERE (invoice_state_id = 4)' })]).then((response) => {
            ...
            if (mode === 'new') {
                ...
                insertItem(formData, entityName, 'multipart/form-data').then(response => {
                    if (response.data.type !== "Error") {
                        let ii = { id: obj.invoice_id, invoice_state_id: 5 };
                        var fd = new FormData();
                ...
                <div className="card ">
                    <div className="card-header border-0">
                        <div className="row align-items-center" ref={GridRef}>
                            <div className="col">
                                <h3 className="mb-0">فرم ارسال به شرکت</h3>
                            </div>
