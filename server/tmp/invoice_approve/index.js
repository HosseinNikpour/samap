    ...
    {mode !== '' && <div className="col">
        <div className="card ">
            ...
            />
                ...
                <div className="form-group">
                    <label className="form-control-label">وضعیت صورتحساب</label>
                      <label className="req-label">*</label>
                    <Select id='result' className={errors.result_id?"form-control error-control":"form-control"} {...Static.selectDefaultProp} disabled={mode === 'display'} options={result_options}
                value={obj.result_id} onSelect={(values) =>  setObj({ ...obj, result_id: values})}
            />
                </div>
            </div></div><div className="row"><div className="col">
                <div className="form-group">
