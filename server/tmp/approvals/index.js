    ...
    {mode !== '' && <div className="col">
        <div className="card ">
            ...
            />
                ...
                <div className="form-group">
                    <label className="form-control-label">نوع پروژه</label>
                      <label className="req-label">*</label>
                    <Select id='project_type' className={errors.project_type_id?"form-control error-control":"form-control"} {...Static.selectDefaultProp} disabled={mode === 'display'} options={project_type_options}
                value={obj.project_type_id} onSelect={(values) =>  setObj({ ...obj, project_type_id: values})}
            />
                </div>
            </div></div><div className="row"><div className="col">
                <div className="form-group">
                    <label className="form-control-label">زمان بندی تحویل</label>
                      <label className="req-label">*</label>
                    <DatePicker id='delivery_schedule' onChange={value =>  setObj({ ...obj, delivery_schedule: value})}
                value={obj.delivery_schedule} disabled={mode === 'display'} {...Static.datePickerDefaultProp}
                className={errors.delivery_schedule ? "form-control error-control" : 'form-control'} />
                </div>
            </div></div><div className="row"><div className="col">
                <div className="form-group">
                    <label className="form-control-label">زمان بندی ارسال پروپوزال</label>
                      <label className="req-label">*</label>
                    <DatePicker id='proposal_schedule' onChange={value =>  setObj({ ...obj, proposal_schedule: value})}
                value={obj.proposal_schedule} disabled={mode === 'display'} {...Static.datePickerDefaultProp}
                className={errors.proposal_schedule ? "form-control error-control" : 'form-control'} />
                </div>
            </div></div><div className="row"><div className="col">
                <div className="form-group">
