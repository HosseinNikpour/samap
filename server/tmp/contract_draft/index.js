        ...
        <div className="card ">
            <div className="card-header border-0">
                <div className="row align-items-center" ref={GridRef}>
                    <div className="col">
                        <h3 className="mb-0">ارسال پیش نویس به مدیریت امور تداکات و مهندسی</h3>
                    </div>
    ...
    {mode !== '' && <div className="col">
        <div className="card ">
            ...
            />
                ...
                <div className="form-group">
                    <label className="form-control-label">تاریخ نامه</label>
                      <label className="req-label">*</label>
                ...
                <div className="form-group">
                    <label className="form-control-label">شناسه نامه</label>
                      <label className="req-label">*</label>
                ...
                <div className="form-group">
                    <label className="form-control-label">مهلت</label>
                      ...
                      <input id='deadline' className={errors.deadline?"form-control error-control":"form-control"} type="text" value={obj.deadline} 
                onChange={(e) => setObj({ ...obj, deadline: e.target.value })} disabled={mode === 'display'} />
                </div>
            </div></div>
